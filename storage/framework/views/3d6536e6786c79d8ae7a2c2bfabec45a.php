...
<script src="<?php echo e(asset('js/accessibility.js')); ?>"></script>
    <div class="container">
        ...
        <a href="<?php echo e(route('filmy.create')); ?>" class="btn btn-primary mb-3">Dodaj film</a>
            ...
            <tbody>
                <?php $__currentLoopData = $filmy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $film): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($film->gatunek); ?></td>
                        <td><?php echo e($film->rezyser); ?></td>
                        <td><?php echo e($film->rok_produkcji); ?></td>
                        <td><?php echo e($film->opis); ?></td>
                        <td>
                            <!-- Link do edytowania filmu -->
                            <a href="<?php echo e(route('filmy.edit', $film->id)); ?>" class="btn btn-warning btn-sm">Edytuj</a>
                            

                            <!-- Formularz do usuwania z potwierdzeniem -->
                            <form action="<?php echo e(route('filmy.destroy', $film->id)); ?>" method="POST" onsubmit="return confirm('Czy na pewno chcesz usunąć ten bilet?');" style="display:inline-block;">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\ddd\q\resources\views/filmy/index.blade.php ENDPATH**/ ?>